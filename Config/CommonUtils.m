...
- (NSString *)encodeToBase64String:(UIImage *)image byCompressionRatio:(float)compressionRatio {
    ...
    NSString *photo = [NSString base64StringFromData:data length:[data length]];
...
//- (void)setRBUserPhoto:(UIImageView *)imageView byPhotoUrl:(NSString *)photoUrl {
//    
//    [commonUtils cropCircleImage:imageView];
//    [imageView setImage:[UIImage imageNamed:@"user_avatar"]];
//    [imageView setContentMode:UIViewContentModeScaleAspectFit];
//    
//    if([photoUrl rangeOfString:MEDIA_AVATAR_SELF_DOMAIN_PREFIX].location != NSNotFound) {
//        NSString *avatarTag = [photoUrl substringFromIndex:[MEDIA_AVATAR_SELF_DOMAIN_PREFIX length]];
//        for(NSMutableDictionary *dic in appController.avatars) {
//            if([[dic objectForKey:@"tag"] isEqualToString:avatarTag]) {
//                [imageView setBackgroundColor:[dic objectForKey:@"color"]];
//                break;
//            }
//        }
//    } else {
//        NSString *imageUrl = [self getFullPhotoUrl:photoUrl withType:@"user"];
//        [commonUtils setImageViewAFNetworking:imageView withImageUrl:imageUrl withPlaceholderImage:[UIImage imageNamed:@"user_default_avatar"]];
//    }
//    
//}
